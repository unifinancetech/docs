# unifinancetech Terminal

[unifinancetech Terminal](https://unifinancetech.finance) provide a terminal UI for professional users.

Use [unifinancetech Web App](https://app.unifinancetech.finance/) or [Income Page of Flamingo](https://flamingo.finance/income) if you feel the terminal UI is uncomfortable.

# Commands

- [add-liquidity](add-liquidity.md)
- [claim-reward-of-staking](claim-reward-of-staking.md)
- [connect-wallet](connect-wallet.md)
- [create-new-vote](create-new-vote.md)
- [deposit-ftoken-to-normalizer](deposit-ftoken-to-normalizer.md)
- [deposit-token-to-vault](deposit-token-to-vault.md)
- [get-amount-of-staking](get-amount-of-staking.md)
...
- [get-earning-of-staking](get-earning-of-staking.md)
- [get-price-of-ftoken-by-symbol](get-price-of-ftoken-by-symbol.md)
- [get-reward](get-reward.md)
...
- [show-voting-list](show-voting-list.md)
- [stake-lptoken](stake-lptoken.md)
- [unstake-lptoken](unstake-lptoken.md)
...
- [withdraw-lp-token](withdraw-lp-token.md)
